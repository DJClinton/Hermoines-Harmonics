...
public class BuyerController {
     ...
     * 
     * @param buyerDao The {@link BuyerDAO Buyer Data Access Object} to perform CRUD operations
     * <br>
     ...
     * 
     * @return ResponseEntity with {@link Buyer buyer} object and HTTP status of OK if found<br>
     ...
     * 
     * @return ResponseEntity with array of {@link Buyer buyer} objects (may be empty) and
     ...
     * 
     * @return ResponseEntity with created {@link Buyer buyer} object and HTTP status of CREATED<br>
    ...
    /**
     * Updates the {@linkplain Buyer buyer} with the provided {@linkplain Buyer buyer} object, if it exists
     * 
     * @param buyer The {@link Buyer buyer} to update
     * 
     * @return ResponseEntity with updated {@link Buyer buyer} object and HTTP status of OK if updated<br>
     * ResponseEntity with HTTP status of NOT_FOUND if not found<br>
     * ResponseEntity with HTTP status of INTERNAL_SERVER_ERROR otherwise
     */
    @PutMapping("")
